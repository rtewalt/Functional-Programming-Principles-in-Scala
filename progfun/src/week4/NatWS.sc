...
object NatWS {
  ...
  val four = two + two                            //> four  : week4.Nat = week4.Successor@7c067f03
  four.predecessor.predecessor.predecessor.predecessor.predecessor
                                                  //> java.util.NoSuchElementException: Zero.predecessor
